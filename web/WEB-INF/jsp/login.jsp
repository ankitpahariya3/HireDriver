...
<spring:url value="/Resources/web2/css" var="css"/>
<spring:url value="/Resources/web2/js" var="js"/>
<spring:url value="/Resources/web2/images" var="images"/>
	...
	<div class="bg-layer">
		...
		<div class="header-main">
			...
			<div class="header-left-bottom">
				...
				<form action="isUserValid" method="post">
					<div class="icon1">
